    ...
    public class ProductSpecification : BaseSpecification<Product>
    {
            ...
            )
        {
            ...
            if (!string.IsNullOrEmpty(productParams.Sort))
            {
                ...
                {
                    case "nombreAsc": AddOrderBy(p => p.Nombre!); break;
                    case "nombreDesc": AddOrderByDescending(p => p.Nombre!); break;
                    case "precioAsc": AddOrderBy(p => p.Precio!); break;
                    case "PrecioDesc": AddOrderByDescending(p => p.Precio!); break;
                    case "ratingAsc": AddOrderBy(p => p.Rating!); break;
                    case "ratingDesc": AddOrderByDescending(p => p.Rating!); break;
                    default: AddOrderBy(p => p.CreateDate!); break;
                }
            }
            else
            {
