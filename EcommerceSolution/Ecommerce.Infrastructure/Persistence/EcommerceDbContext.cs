...
namespace Ecommerce.Infrastructure.Persistence
{
    public class EcommerceDbContext : IdentityDbContext<Usuario>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            /* Realcion de uno a muchos entre Categoria y Producto */
            ...
            /* Realcion de uno a muchos entre Producto y Reviews */
            ...
            /* Realcion de uno a muchos entre Producto y Imagenes */
            builder.Entity<Product>()
                .HasMany(p => p.Images)
                .WithOne(r => r.Product)
                .HasForeignKey(r => r.ProductId)
            ...
            /* Realcion de uno a muchos entre ShoppingCarts y ShoppingCartItems */
